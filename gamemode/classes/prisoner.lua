...
function PLAYER:Loadout()
	...
	if math.random(1,JB.Config.prisonerSpecialChance) == 1 then
		self.Player:Give(table.Random(randomSpecialWeapon)); -- give the player a randon weapon from our table.
	end
end
...
-- Black models (we add these a few times, so it increases the chance of a player being black, which makes the atmosphere of the game more "criminal")
	Model("models/poseidonservers/psprisoners/poseidon_prisoner_female03.mdl"),
	Model("models/poseidonservers/psprisoners/poseidon_prisoner_male01.mdl"),
	Model("models/poseidonservers/psprisoners/poseidon_prisoner_male03.mdl"),
	Model("models/poseidonservers/psprisoners/poseidon_prisoner_female03.mdl"),
	Model("models/poseidonservers/psprisoners/poseidon_prisoner_male01.mdl"),
	Model("models/poseidonservers/psprisoners/poseidon_prisoner_male03.mdl"),
	Model("models/poseidonservers/psprisoners/poseidon_prisoner_female03.mdl"),
...
-- Normal 'white' models
	Model("models/poseidonservers/psprisoners/poseidon_prisoner_female02.mdl"),
	Model("models/poseidonservers/psprisoners/poseidon_prisoner_female01.mdl"),
	Model("models/poseidonservers/psprisoners/poseidon_prisoner_female04.mdl"),
	Model("models/poseidonservers/psprisoners/poseidon_prisoner_female06.mdl"),
	Model("models/poseidonservers/psprisoners/poseidon_prisoner_male02.mdl"),
	Model("models/poseidonservers/psprisoners/poseidon_prisoner_male04.mdl"),
	Model("models/poseidonservers/psprisoners/poseidon_prisoner_male05.mdl"),
	Model("models/poseidonservers/psprisoners/poseidon_prisoner_male06.mdl"),
	Model("models/poseidonservers/psprisoners/poseidon_prisoner_male07.mdl"),
	Model("models/poseidonservers/psprisoners/poseidon_prisoner_male08.mdl"),
	Model("models/poseidonservers/psprisoners/poseidon_prisoner_male09.mdl"),
}
