...
wardenMarkers["generic"] = {
    text = "Move",
    icon = Material("jailbreak_excl/pointers/generic.png")
}

wardenMarkers["exclamation"] = {
    text = "Attack",
    icon = Material("jailbreak_excl/pointers/exclamation.png")
}

wardenMarkers["question"] = {
    text = "Check out",
    icon = Material("jailbreak_excl/pointers/question.png")
}

wardenMarkers["line"] = {
    text = "Line up",
    icon = Material("jailbreak_excl/pointers/line.png")
}

wardenMarkers["cross"] = {
    text = "Avoid",
    icon = Material("jailbreak_excl/pointers/cross.png")
}
