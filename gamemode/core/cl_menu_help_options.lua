...
local frame
local slide_cur = 1
local guide_slides = {Material("jailbreak_excl/guide/slide_1.png"), Material("jailbreak_excl/guide/slide_2.png"), Material("jailbreak_excl/guide/slide_3.png"), Material("jailbreak_excl/guide/slide_4.png")}
...
function JB.MENU_HELP_OPTIONS()
    ...
    btn_options.OnMouseReleased = function()
        ...
        for k, v in ipairs{{"jb_cl_option_toggleaim", "toggle", "Toggle aim (default: Right Mouse)"}, {"jb_cl_option_togglecrouch", "toggle", "Toggle crouch (default: CTRL)"}, {"jb_cl_option_togglewalk", "toggle", "Toggle walk (default: ALT)"}, {"jb_cl_option_always_spectate", "toggle", "Always spawn as spectator after joining"}} do
